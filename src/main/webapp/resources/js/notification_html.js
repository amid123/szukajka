...
var notification_html = [];
    ...
    notification_html[1] = '<div class="activity-item"> <i class="fa fa-check text-success"></i> <div class="activity"> Aby kupować musisz połączyć swoje konto z serwisem Allegro. Aby to zrobić przejdź do zakładki ustawienia</div> </div>',
