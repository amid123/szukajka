...
<!--                            <li><a href="<c:url value="/login" />">Zaloguj</a>	</li>-->
        ...
        <section class="container">
            <h1>To jest Twoja strona główna przed zalogowaniem. Tutaj musisz wymyśleć jakieś treści.</h1>
<!--            <img src="<c:url value="/resources/img/indexfoto.jpg"/>" alt="Kupujemy od jednego">-->
